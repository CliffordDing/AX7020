...
# executing this script. Please type 'adc_buf.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key adc_buf_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc adc_buf_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../src/adc_buf/sim/adc_buf.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.adc_buf -o adc_buf_simv
}
...
simulate()
{
  ...
  ./adc_buf_simv $opts -do simulate.do
}
# Script usage
usage()
{
