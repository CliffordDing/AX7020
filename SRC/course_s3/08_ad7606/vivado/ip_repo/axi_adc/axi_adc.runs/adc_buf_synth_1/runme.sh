...
HD_PWD='D:/test/ad7606_test_v2/axi_adc/axi_adc.runs/adc_buf_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_buf.vds -m64 -mode batch -messageDb vivado.pb -notrace -source adc_buf.tcl
