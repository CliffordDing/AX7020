...
#define  USBD_CFG_MAX_NBR_IF_GRP                           0u
...
*
* Note(s) : (1) This constant is only used when MSC class interfaces with uC/FS. This constant should
*               be DEF_ENABLED when using a removable media such as SD card. Fixed media such as RAMDisk,
*               NAND should have this constant set to DEF_DISABLED.
*
