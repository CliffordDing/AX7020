...
*
* File          : usbd_drv_synopsys_otg_hs.c
* Version       : V4.05.00.01
* Programmer(s) : FGK
*                 FT
*                 OD
                                        ...
                                        USBD_ERR    *p_err)
{
...
#if (CPU_CFG_CACHE_MGMT_EN == DEF_ENABLED)                      /* See Note #1.                                         */
    {
        ...
        CPU_DCACHE_RANGE_FLUSH(p_cache_aligned_buf_addr, len);  /* See Note #2.                                         */
    }
#endif
                                   ...
                                   USBD_ERR    *p_err)
{
...
#if (CPU_CFG_CACHE_MGMT_EN == DEF_ENABLED)                      /* See Note #1.                                         */
    {
        ...
        CPU_DCACHE_RANGE_INV(p_cache_aligned_buf_addr, len);    /* Invalidate (clear) the cached RAM block, so that the */
                                  ...
                                  USBD_ERR    *p_err)
{
...
#if (CPU_CFG_CACHE_MGMT_EN == DEF_ENABLED)                      /* See Note #1.                                         */
    {
        ...
        CPU_DCACHE_RANGE_FLUSH(p_cache_aligned_buf_addr, len);  /* Write the cached memory block back to RAM, before... */
