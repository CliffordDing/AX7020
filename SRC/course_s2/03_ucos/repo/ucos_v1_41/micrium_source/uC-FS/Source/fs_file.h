...
#define  FS_FILE_ORIGIN_START                    DEF_BIT_00     /* Origin is beginning of file.                         */
#define  FS_FILE_ORIGIN_CUR                      DEF_BIT_01     /* Origin is current file position.                     */
#define  FS_FILE_ORIGIN_END                      DEF_BIT_02     /* Origin is end of file.                               */
