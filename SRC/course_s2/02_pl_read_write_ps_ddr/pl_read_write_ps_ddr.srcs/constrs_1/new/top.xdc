...
set_property C_INPUT_PIPE_STAGES 1 [get_debug_cores u_ila_0_0]
...
connect_debug_port u_ila_0_0/clk [get_nets [list ps_block/system_i/processing_system7_0/inst/FCLK_CLK0]]
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0_0/probe0]
set_property port_width 10 [get_debug_ports u_ila_0_0/probe0]
connect_debug_port u_ila_0_0/probe0 [get_nets [list {wr_burst_len[0]} {wr_burst_len[1]} {wr_burst_len[2]} {wr_burst_len[3]} {wr_burst_len[4]} {wr_burst_len[5]} {wr_burst_len[6]} {wr_burst_len[7]} {wr_burst_len[8]} {wr_burst_len[9]}]]
...
connect_debug_port u_ila_0_0/probe6 [get_nets [list {mem_test_m0/wr_cnt[0]} {mem_test_m0/wr_cnt[1]} {mem_test_m0/wr_cnt[2]} {mem_test_m0/wr_cnt[3]} {mem_test_m0/wr_cnt[4]} {mem_test_m0/wr_cnt[5]} {mem_test_m0/wr_cnt[6]} {mem_test_m0/wr_cnt[7]}]]
create_debug_port u_ila_0_0 probe
...
connect_debug_port u_ila_0_0/probe7 [get_nets [list {mem_test_m0/state[0]} {mem_test_m0/state[1]} {mem_test_m0/state[2]}]]
create_debug_port u_ila_0_0 probe
...
connect_debug_port u_ila_0_0/probe8 [get_nets [list {mem_test_m0/rd_cnt[0]} {mem_test_m0/rd_cnt[1]} {mem_test_m0/rd_cnt[2]} {mem_test_m0/rd_cnt[3]} {mem_test_m0/rd_cnt[4]} {mem_test_m0/rd_cnt[5]} {mem_test_m0/rd_cnt[6]} {mem_test_m0/rd_cnt[7]}]]
create_debug_port u_ila_0_0 probe
...
connect_debug_port u_ila_0_0/probe9 [get_nets [list {u_aq_axi_master/wr_state[0]} {u_aq_axi_master/wr_state[1]} {u_aq_axi_master/wr_state[2]}]]
create_debug_port u_ila_0_0 probe
...
connect_debug_port u_ila_0_0/probe10 [get_nets [list mem_test_m0/error]]
create_debug_port u_ila_0_0 probe
...
connect_debug_port u_ila_0_0/probe11 [get_nets [list error_OBUF]]
create_debug_port u_ila_0_0 probe
...
connect_debug_port u_ila_0_0/probe12 [get_nets [list u_aq_axi_master/M_AXI_ARREADY]]
create_debug_port u_ila_0_0 probe
...
connect_debug_port u_ila_0_0/probe13 [get_nets [list u_aq_axi_master/M_AXI_AWREADY]]
create_debug_port u_ila_0_0 probe
...
connect_debug_port u_ila_0_0/probe14 [get_nets [list rd_burst_data_valid]]
create_debug_port u_ila_0_0 probe
...
connect_debug_port u_ila_0_0/probe15 [get_nets [list rd_burst_finish]]
create_debug_port u_ila_0_0 probe
...
connect_debug_port u_ila_0_0/probe16 [get_nets [list rd_burst_req]]
create_debug_port u_ila_0_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0_0/probe17]
set_property port_width 1 [get_debug_ports u_ila_0_0/probe17]
connect_debug_port u_ila_0_0/probe17 [get_nets [list wr_burst_data_req]]
create_debug_port u_ila_0_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0_0/probe18]
set_property port_width 1 [get_debug_ports u_ila_0_0/probe18]
connect_debug_port u_ila_0_0/probe18 [get_nets [list wr_burst_finish]]
create_debug_port u_ila_0_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0_0/probe19]
set_property port_width 1 [get_debug_ports u_ila_0_0/probe19]
connect_debug_port u_ila_0_0/probe19 [get_nets [list wr_burst_req]]
